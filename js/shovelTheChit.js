...
var chit = document.createElement("canvas");
chit.id = 'chit';
// Pega o seu contexto de desenho
var ctx = chit.getContext("2d");

// Cria o chit final (desenharemos a imagem nele e depois o chit da raspadinha em cima dele)
